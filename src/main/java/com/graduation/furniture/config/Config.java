package com.graduation.furniture.config;
...
public class Config {
    ...
    public static String vnp_ReturnUrl = "http://localhost:3000/payment";
        public static String vnp_TmnCode = "2NNRTM7V";
        public static String vnp_HashSecret = "SKVMDQNSBWSJATTAKSFODXYUVQSZNTFQ";

//    public static String vnp_TmnCode = "9O4XFXLN";
//    public static String vnp_HashSecret = "OXFEAXBZJUFYBYMEHERHKXUSTMQEOEYN";
